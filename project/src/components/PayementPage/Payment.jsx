       ...
       <div className="left_payment">
           ...
           <div className="form_div">
               ...
               <form onSubmit={(e)=>submitfun(e)}>
                    <input className="name" type="text" placeholder="Name on Card*" required></input><br></br><br></br>
                   <input className="card_number" type="number" placeholder="Card Number*"  required></input><br></br><br></br>
                   <input className="date" type="date" placeholder="Expiry Date*" required></input>
                   <input className="security" type="number" placeholder="Security Code*" min="100" max="999" required></input><br></br><br></br>
