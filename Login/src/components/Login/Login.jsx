...
export const Login = () => {
    ...
    <input type = "email" placeholder='name@ email.com' className='login_pw' id="email" onChange={handlechange} ></input><br />

      <label htmlFor="Full Name" className='login_pw_head'>PASSWORD</label><br />
 <input type = "password" placeholder='Enter your  Password' className='login_pw'id="password" onChange={handlechange}></input><br />
                   
                <button onClick={handleSubmit}  id = "signup_input">Login</button>
                <div id = "line">
            <div><hr /></div>Or
            <div><hr /></div>
